...
/*Para solucionar o problema de ao voltar a página não ficar preta classe MateriaApp foi excluída
* O motivo, pelo entendido, é que tal classe ao criaria um novo aplicativo e logo um novo objeto
* NAvigator sem relação com o da página de frente.*/
      ...
      appBar: AppBar(
        title: Row(
          children: <Widget>[
            ...
            Text('My First App - DSI/BSI/UFRPE'),//widget.title,),
            Spacer(),
